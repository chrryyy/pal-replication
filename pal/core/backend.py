...
def call_hf(prompt, pipe, temperature=0., top_p=1.0, max_tokens=128, majority_at=None):
    num_completions = majority_at if majority_at is not None else 1
    num_completions_batch_size = 5

    print("Starting completions")
    completions = []
    for i in range(20 * (num_completions // num_completions_batch_size + 1)):
        try:
            ...
            ans = pipe(
                ...
                do_sample=True,
                top_p=top_p,
                num_return_sequences=requested_completions,
            ...
            print("Exception getting answer")
            print(e)
    raise RuntimeError('Failed to call HF API')
